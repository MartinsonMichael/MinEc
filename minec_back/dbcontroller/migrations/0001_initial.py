# Generated by Django 2.1.7 on 2019-06-16 11:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_add_to_base', models.DateField(null=True, verbose_name='дата добавления в базу')),
                ...
                ('life_duration_years', models.IntegerField(null=True, verbose_name='продолжительность существования (лет)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inn', models.TextField(max_length=20, null=True, unique=True, verbose_name='ИНН')),
                ...
                ('region_name', models.TextField(choices=[(1, 'адыгея республика'), (2, 'башкортостан республика'), (3, 'бурятия республика'), (4, 'алтай республика'), (5, 'дагестан республика'), (6, 'ингушетия республика'), (7, 'кабардино-балкарская республика'), (8, 'калмыкия республика'), (9, 'карачаево-черкесская республика'), (10, 'карелия республика'), (11, 'коми республика'), (12, 'марий эл республика'), (13, 'мордовия республика'), (14, 'саха - якутия республика'), (15, 'северная осетия'), (16, 'татарстан республика'), (17, 'тыва республика'), (18, 'удмуртская республика'), (19, 'хакасия республика'), (20, 'чеченская республика'), (21, 'чувашская республика'), (22, 'алтайский край'), (23, 'краснодарский край'), (24, 'красноярский край'), (25, 'приморский край'), (26, 'ставропольский край'), (27, 'хабаровский край'), (28, 'амурская область'), (29, 'архангельская область'), (30, 'астраханская область'), (31, 'белгородская область'), (32, 'брянская область'), (33, 'владимирская область'), (34, 'волгоградская область'), (35, 'вологодская область'), (36, 'воронежская область'), (37, 'ивановская область'), (38, 'иркутская область'), (39, 'калининградская область'), (40, 'калужская область'), (41, 'камчатский край'), (42, 'кемеровская область'), (43, 'кировская область'), (44, 'костромская область'), (45, 'курганская область'), (46, 'курская область'), (47, 'ленинградская область'), (48, 'липецкая область'), (49, 'магаданская область'), (50, 'московская область'), (51, 'мурманская область'), (52, 'нижегородская область'), (53, 'новгородская область'), (54, 'новосибирская область'), (55, 'омская область'), (56, 'оренбургская область'), (57, 'орловская область'), (58, 'пензенская область'), (59, 'пермский край'), (60, 'псковская область'), (61, 'ростовская область'), (62, 'рязанская область'), (63, 'самарская область'), (64, 'саратовская область'), (65, 'сахалинская область'), (66, 'свердловская область'), (67, 'смоленская область'), (68, 'тамбовская область'), (69, 'тверская область'), (70, 'томская область'), (71, 'тульская область'), (72, 'тюменская область'), (73, 'ульяновская область'), (74, 'челябинская область'), (75, 'забайкальский край'), (76, 'ярославская область'), (77, 'москва город'), (78, 'санкт-петербург город'), (79, 'еврейская автономная область'), (81, 'пермский край'), (83, 'ненецкий автономный округ'), (85, 'иркутская область'), (86, 'ханты-мансийский автономный округ'), (87, 'чукотский автономный округ'), (89, 'ямало-ненецкий автономный округ'), (91, 'крым республика'), (92, 'севастополь город')], default='НЕИЗВЕСТНО', null=True, verbose_name='Название региона')),
                ('federal_name', models.TextField(choices=[(31, 'Центральный федеральный округ'), (32, 'Центральный федеральный округ'), (33, 'Центральный федеральный округ'), (36, 'Центральный федеральный округ'), (37, 'Центральный федеральный округ'), (40, 'Центральный федеральный округ'), (44, 'Центральный федеральный округ'), (46, 'Центральный федеральный округ'), (48, 'Центральный федеральный округ'), (50, 'Центральный федеральный округ'), (57, 'Центральный федеральный округ'), (62, 'Центральный федеральный округ'), (67, 'Центральный федеральный округ'), (68, 'Центральный федеральный округ'), (69, 'Центральный федеральный округ'), (71, 'Центральный федеральный округ'), (76, 'Центральный федеральный округ'), (77, 'Центральный федеральный округ'), (81, 'Приволжский федеральный округ'), (43, 'Приволжский федеральный округ'), (52, 'Приволжский федеральный округ'), (56, 'Приволжский федеральный округ'), (58, 'Приволжский федеральный округ'), (63, 'Приволжский федеральный округ'), (64, 'Приволжский федеральный округ'), (73, 'Приволжский федеральный округ'), (2, 'Приволжский федеральный округ'), (12, 'Приволжский федеральный округ'), (13, 'Приволжский федеральный округ'), (16, 'Приволжский федеральный округ'), (18, 'Приволжский федеральный округ'), (21, 'Приволжский федеральный округ'), (29, 'Северо-Западный федеральный округ'), (35, 'Северо-Западный федеральный округ'), (39, 'Северо-Западный федеральный округ'), (47, 'Северо-Западный федеральный округ'), (51, 'Северо-Западный федеральный округ'), (53, 'Северо-Западный федеральный округ'), (60, 'Северо-Западный федеральный округ'), (10, 'Северо-Западный федеральный округ'), (78, 'Северо-Западный федеральный округ'), (83, 'Северо-Западный федеральный округ'), (11, 'Северо-Западный федеральный округ'), (45, 'Уральский федеральный округ'), (66, 'Уральский федеральный округ'), (72, 'Уральский федеральный округ'), (74, 'Уральский федеральный округ'), (86, 'Уральский федеральный округ'), (89, 'Уральский федеральный округ'), (23, 'Южный федеральный округ'), (30, 'Южный федеральный округ'), (34, 'Южный федеральный округ'), (61, 'Южный федеральный округ'), (1, 'Южный федеральный округ'), (8, 'Северо-Кавказский федеральный округ'), (91, 'Южный федеральный округ'), (92, 'Южный федеральный округ'), (22, 'Сибирский федеральный округ'), (85, 'Сибирский федеральный округ'), (42, 'Сибирский федеральный округ'), (54, 'Сибирский федеральный округ'), (55, 'Сибирский федеральный округ'), (70, 'Сибирский федеральный округ'), (17, 'Сибирский федеральный округ'), (19, 'Сибирский федеральный округ'), (24, 'Сибирский федеральный округ'), (4, 'Сибирский федеральный округ'), (26, 'Северо-Кавказский федеральный округ'), (5, 'Северо-Кавказский федеральный округ'), (6, 'Северо-Кавказский федеральный округ'), (15, 'Северо-Кавказский федеральный округ'), (20, 'Северо-Кавказский федеральный округ'), (7, 'Северо-Кавказский федеральный округ'), (9, 'Северо-Кавказский федеральный округ'), (75, 'Дальневосточный федеральный округ'), (41, 'Дальневосточный федеральный округ'), (25, 'Дальневосточный федеральный округ'), (27, 'Дальневосточный федеральный округ'), (28, 'Дальневосточный федеральный округ'), (49, 'Дальневосточный федеральный округ'), (65, 'Дальневосточный федеральный округ'), (3, 'Дальневосточный федеральный округ'), (79, 'Дальневосточный федеральный округ'), (87, 'Дальневосточный федеральный округ'), (14, 'Дальневосточный федеральный округ')], default='НЕИЗВЕСТНО', max_length=50, verbose_name='федеральный округ')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeNum',
            fields=[
                ...
                ('_company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dbcontroller.Company')),
            ],
        ),
        migrations.CreateModel(
            name='OKVED',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.TextField(max_length=21, null=True, verbose_name='Код ОКВЭД')),
                ('code_name', models.TextField(max_length=160, null=True, verbose_name='Название ОКВЭД')),
                ('is_prime', models.BooleanField(null=True, verbose_name='Основное ОКВЭД?')),
                ('_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dbcontroller.Company')),
            ],
        ),
        migrations.CreateModel(
            name='ScheduleTable',
            fields=[
                ...
                ('type', models.TextField(choices=[(0, 'NONE'), (1, 'load'), (2, 'unzip'), (3, 'add'), (4, 'done')], default='NONE')),
                ('zip_file_name', models.TextField(max_length=30, null=True)),
                ('base_name', models.TextField(max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(verbose_name='дата помещения в базу')),
