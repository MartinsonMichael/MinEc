    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disappear_factor', models.TextField(max_length=100, null=True, verbose_name='причина прекращения существования')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upd_date', models.DateField(verbose_name='technical filed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_category', models.TextField(choices=[(0, 'тип не определн'), (1, 'микропредприятие'), (2, 'малое предприятие'), (3, 'среднее предприятие')], default=0, max_length=20, verbose_name='категория компании')),
                ...
                ('federal_name', models.TextField(choices=[(0, 'Центральный федеральный округ'), (1, 'Уральский федеральный округ'), (2, 'Северо-Кавказский федеральный округ'), (3, 'Дальневосточный федеральный округ'), (4, 'Сибирский федеральный округ'), (5, 'Приволжский федеральный округ'), (6, 'Южный федеральный округ'), (7, 'Северо-Западный федеральный округ')], default='НЕИЗВЕСТНО', max_length=50, verbose_name='федеральный округ')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeNum',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(verbose_name='Даты обновлений')),
            ],
        ),
        migrations.CreateModel(
            name='OKVED',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('upd_date', models.DateField(verbose_name='technical filed')),
                ('okved_code', models.TextField(max_length=21, null=True, verbose_name='Код ОКВЭД')),
                ('okved_code_name', models.TextField(max_length=160, null=True, verbose_name='Название ОКВЭД')),
                ('okved_is_prime', models.BooleanField(null=True, verbose_name='Основное ОКВЭД?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.TextField(choices=[(0, 'NONE'), (1, 'load'), (2, 'unzip'), (21, 'need_to_add'), (3, 'add'), (4, 'done')], default='NONE')),
